...
echo "=========Getting VAULT Token from Secrets Manager========="
    ...
    \"Statement\": [
        {
            ...
            \"Resource\": \"arn:aws:dynamodb:${AWS_REGION}:${ACCOUNT_ID}:table/ProductsTable_${RANDOM_STRING}\",
            \"Effect\": \"Allow\",
            \"Condition\": {
...
"
    ...
    eks.amazonaws.com/role-arn=${TENANT_SA_ROLE_ARN}
